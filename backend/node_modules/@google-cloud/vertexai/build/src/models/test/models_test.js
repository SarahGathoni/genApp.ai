...
const StreamFunctions = require("../../functions/post_fetch_processing");
...
describe('ChatSession', () => {
    ...
    beforeEach(() => {
        ...
        spyOnProperty(chatSessionWithNoArgs, 'token', 'get').and.resolveTo(TEST_TOKEN);
        chatSessionWithEmptyResponse = model.startChat();
        spyOnProperty(chatSessionWithEmptyResponse, 'token', 'get').and.resolveTo(TEST_TOKEN);
        chatSessionWithFunctionCall = model.startChat({
            tools: TEST_TOOLS_WITH_FUNCTION_DECLARATION,
        });
        spyOnProperty(chatSessionWithFunctionCall, 'token', 'get').and.resolveTo(TEST_TOKEN);
        expectedStreamResult = {
            response: Promise.resolve(TEST_MODEL_RESPONSE),
            stream: testGenerator(),
        };
